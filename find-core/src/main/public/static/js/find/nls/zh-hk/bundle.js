...
define([
    ...
    return substitution({
        ...
        'login.defaultLogin': '默認登錄信息請查看config.json文件',
        'login.error.auth': '請檢查用戶名與密碼',
        ...
        'search.document.contentType': '內容類型',
        ...
        'search.relatedConcepts.none': '無相關概念',
        ...
        'search.savedSearchControl.openEdit.create': '保存搜索',
        'search.savedSearchControl.openEdit.edit': '保存為',
        'search.savedSearchControl.update': '保存',
