...
define([
    ...
    return substitution({
        ...
        'login.defaultLogin': '默认登陆信息请查看config.json文件',
        'login.error.auth': '请检查用户名与密码',
        ...
        'search.document.authors': '作者',
        'search.document.contentType': '内容类型',
        ...
        'search.relatedConcepts.none': '无相关概念',
